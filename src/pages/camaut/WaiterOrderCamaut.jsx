    ...
    <div className="flex-1 min-h-0 flex flex-col bg-[#F0F4F8]" style={{ minHeight: '420px' }}>
      ...
      <div className="flex-shrink-0 px-4 pt-3 pb-1 flex gap-2 items-center">
        ...
        <button
          ...
          title="Pedido por voz IA"
          className="flex-shrink-0 h-10 flex items-center gap-1.5 px-3 rounded-xl border border-[#008080]/40 bg-[#E8F5F5] text-[#008080] active:bg-[#008080] active:text-white"
        >
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <span className="text-[10px] font-bold tracking-wide">IA</span>
        </button>
      </div>
