    ...
    <div className="min-h-screen bg-carbon-950 flex flex-col items-center justify-center px-5 py-12 relative overflow-hidden">
      ...
      <div className="w-full max-w-sm space-y-8 relative">
        ...
        <div className="text-center">
          <img src="/icon-512.png" alt="Capy" className="w-20 h-20 mx-auto mb-4 drop-shadow-sm" />
        ...
        {/* Seguimiento de pedido, discreto */}
        <div className="text-center">
          {!trackOpen ? (
            <button
              onClick={() => setTrackOpen(true)}
              className="text-smoke-500 text-xs underline underline-offset-2"
            >
              ¿Ya hiciste tu pedido? Seguilo acá
            </button>
          ) : (
